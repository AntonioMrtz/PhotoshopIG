...
public:
    ...
    void setupUi(QDialog *acercade)
    {
        ...
        acercade->resize(390, 190);
        acercade->setMinimumSize(QSize(390, 190));
        acercade->setMaximumSize(QSize(390, 190));
        QIcon icon;
        ...
        label_3->setGeometry(QRect(20, 120, 361, 21));
        ...
        commandLinkButton->setGeometry(QRect(20, 140, 91, 41));
        commandLinkButton->setAutoDefault(true);
        commandLinkButton->setDefault(false);
        frame = new QFrame(acercade);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setGeometry(QRect(20, 10, 101, 101));
        frame->setStyleSheet(QString::fromUtf8("image: url(:/imagenes/logo.png);"));
    ...
    void retranslateUi(QDialog *acercade)
    {
        ...
        label_2->setText(QCoreApplication::translate("acercade", "Versi\303\263n 5.0", nullptr));
        label_3->setText(QCoreApplication::translate("acercade", "(2022) by GinesGM, DIS, Facultad de Inform\303\241tica, Universidad de Murcia", nullptr));
